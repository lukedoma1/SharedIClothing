...
namespace Group8_iCLOTHINGApp.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "statusID,status,statusDate")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "statusID,status,statusDate")] OrderStatus orderStatus)
        {
            if (ModelState.IsValid)
            {
