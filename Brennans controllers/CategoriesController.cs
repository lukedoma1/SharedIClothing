...
namespace Group8.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "parentCategoryID,departmentID,categoryID,categoryName,categoryDescription")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "parentCategoryID,departmentID,categoryID,categoryName,categoryDescription")] Category category)
        {
            if (ModelState.IsValid)
            {
